...
export default function ChatBot() {
  ...
  return (
    <div className="container mx-auto h-screen flex flex-col justify-between">
      ...
      {/* Chat Messages */}
      <div
        className="flex-1 overflow-y-auto p-4 space-y-4 w-full max-w-3xl"
          ...
          >
            <div
              className={`max-w-[70%] rounded-lg p-3 ${
                message.sender === "bot"
                  ? "bg-light-gray text-dark-gray mr-4"
                  : "bg-light-blue text-white ml-4"
              }`}
            >
      ...
      >
        <div className="flex space-x-2 h-full">
          <input
            ...
            className="flex-1 p-2 border text-primary-text-light dark:text-primary-text-dark rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <Button
